 ...
 */ ;(function (a, b) {
    ...
    ;((a.containerWidth = b(g.width)),
      ...
      a.containerWidth + a.settings.scrollXMarginOffset < a.contentWidth
        ? ((a.scrollbarXActive = !0),
          ...
          (a.scrollbarXLeft = n(
            ((a.negativeScrollAdjustment + c.scrollLeft) * (a.railXWidth - a.scrollbarXWidth)) /
      ...
      a.containerHeight + a.settings.scrollYMarginOffset < a.contentHeight
        ? ((a.scrollbarYActive = !0),
          ...
          (a.scrollbarYTop = n(
            (d * (a.railYHeight - a.scrollbarYHeight)) / (a.contentHeight - a.containerHeight)
          )))
  ...
  function r(a, b) {
    var c = Math.min,
      d = Math.max
    return (
      a.settings.minScrollbarLength && (b = d(b, a.settings.minScrollbarLength)),
  ...
  function s(a, c) {
    var d = { width: c.railXWidth },
      e = v(a.scrollTop)
    ;((d.left = c.isRtl
      ? c.negativeScrollAdjustment + a.scrollLeft + c.containerWidth - c.contentWidth
      : a.scrollLeft),
    ...
    G = {
      ...
      'keyboard': function (a) {
        ...
        a.event.bind(a.ownerDocument, 'keydown', function (d) {
          if (
            !((d.isDefaultPrevented && d.isDefaultPrevented()) || d.defaultPrevented) &&
            (f() || g())
          ) {
            ...
            ;(a.settings.suppressScrollX && 0 !== h) ||
              ...
              ((c.scrollTop -= i), (c.scrollLeft += h), q(a), b(h, i) && d.preventDefault())
          }
        })
      },
      'wheel': function (b) {
        ...
        'undefined' == typeof window.onwheel
          ? 'undefined' != typeof window.onmousewheel && b.event.bind(h, 'mousewheel', g)
      ...
      'touch': function (b) {
        function c(a, c) {
          ...
          if (g > f) {
            ...
            f > g &&
            ((0 > a && e === b.contentWidth - b.containerWidth) || (0 < a && 0 === e))
          )
    ...
    H = function (d, e) {
      ...
      ;((this.scrollbarXBottom = parseInt(j.bottom, 10)),
        isNaN(this.scrollbarXBottom)
          ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = n(j.top)))
      ...
      ;((this.scrollbarYRight = parseInt(k.right, 10)),
        isNaN(this.scrollbarYRight)
          ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = n(k.left)))
    ...
    (H.prototype.update = function () {
      this.isAlive && // Recalcuate negative scrollLeft adjustment
        ...
        (this.railXMarginWidth =
          n(a(this.scrollbarXRail).marginLeft) + n(a(this.scrollbarXRail).marginRight)),
        (this.railYMarginHeight =
          n(a(this.scrollbarYRail).marginTop) + n(a(this.scrollbarYRail).marginBottom)),
