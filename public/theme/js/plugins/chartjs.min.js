...
!(function (t, e) {
  ...
  var a = new (class {
    ...
    _update(t = Date.now()) {
      ...
      ;(e._charts.forEach((n, o) => {
        ...
        for (; r >= 0; --r)
          ((a = s[r]),
            a._active
              ? (a._total > n.duration && (n.duration = a._total), a.tick(t), (l = !0))
    ...
    _getAnims(t) {
      ...
      return (
        i ||
          ((i = { running: !1, items: [], listeners: { complete: [], progress: [] } }),
          e.set(t, i)),
        i
      )
    }
  ...
  function I(t) {
    ...
    return (
      Array.isArray(t)
        ? t.length >= 3 &&
          ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = m(t[3])))
  ...
  class z {
    ...
    rgbString() {
      return this._valid
        ? (t = this._rgb) &&
            (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${x(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
        : this._rgb
      var t
    }
    hexString() {
  ...
  function Yt(t, e, i, n) {
    ...
    ;(n.font !== e && ((o = n.data = {}), (s = n.garbageCollect = []), (n.font = e)),
      t.save(),
      (t.font = e))
    let a = 0
    const r = i.length
    ...
    update(t, e, i, n) {
      ...
      ;(!(function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          ((o = t[i]),
            o.horizontal
              ? ((o.width = o.box.fullSize && e.availableWidth), (o.height = e.hBoxMaxHeight))
              : ((o.width = e.vBoxMaxWidth), (o.height = o.box.fullSize && e.availableHeight)))
      })(l.concat(c), d),
        Ye(r.fullSize, f, d),
        Ye(l, f, d),
        Ye(c, f, d) && Ye(l, f, d),
  ...
  const hi = (t) => 0 === t || 1 === t,
    ...
    ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) + 1,
      ...
      easeInOutElastic(t) {
        const e = 0.1125
        return hi(t) ? t : t < 0.5 ? 0.5 * di(2 * t, e, 0.45) : 0.5 + 0.5 * ui(2 * t - 1, e, 0.45)
      },
      easeInBack(t) {
        const e = 1.70158
        return t * t * ((e + 1) * t - e)
  ...
  class Ai {
    ...
    parsePrimitiveData(t, e, i, n) {
      ...
      let d, u, f
      for (d = 0, u = n; d < u; ++d)
        ((f = d + i), (h[d] = { [a]: c || o.parse(l[f], f), [r]: s.parse(e[f], f) }))
      return h
    }
    parseArrayData(t, e, i, n) {
      ...
      let r, l, c, h
      for (r = 0, l = n; r < l; ++r)
        ((c = r + i), (h = e[c]), (a[r] = { x: o.parse(h[0], c), y: s.parse(h[1], c) }))
      return a
    }
    parseObjectData(t, e, i, n) {
      ...
      let c, h, d, u
      for (c = 0, h = n; c < h; ++c)
        ((d = c + i), (u = e[d]), (l[c] = { x: o.parse(lt(u, a), d), y: s.parse(lt(u, r), d) }))
      return l
    }
    getParsed(t) {
    ...
    _update(t) {
      ...
      ;(e.configure(),
        ...
        (i._clip = (function (t) {
          let e, i, n, o
          return (
            U(t) ? ((e = t.top), (i = t.right), (n = t.bottom), (o = t.left)) : (e = i = n = o = t),
  ...
  class ji extends Oi {
    ...
    update(t, e, i) {
      ...
      ;(n.beforeUpdate(),
        (n.maxWidth = t),
        (n.maxHeight = e),
        (n._margins = i = Object.assign({ left: 0, right: 0, top: 0, bottom: 0 }, i)),
        (n.ticks = null),
        (n._labelSizes = null),
    ...
    configure() {
      ...
      let e,
        i,
        n = t.options.reverse
      ;(t.isHorizontal() ? ((e = t.left), (i = t.right)) : ((e = t.top), (i = t.bottom), (n = !n)),
        (t._startPixel = e),
        (t._endPixel = i),
        (t._reversePixels = n),
        (t._length = i - e),
        ...
        if (
          ...
          if (Y(c))
            for (r = 0, l = c.length; r < l; ++r)
              ((m = c[r]), $(m) || Y(m) || ((g = $t(i, u.data, u.gc, g, m)), (p += f)))
    ...
    _computeGridLineItems(t) {
      ...
      if ('top' === a)
        ((m = p(e.bottom)), (v = e.bottom - h), (w = m - g), (S = p(t.top) + g), (D = t.bottom))
      else if ('bottom' === a)
        ((m = p(e.top)), (S = t.top), (D = p(t.bottom) - g), (v = m + g), (w = e.top + h))
      else if ('left' === a)
        ((m = p(e.right)), (y = e.right - h), (M = m - g), (k = p(t.left) + g), (P = t.right))
      else if ('right' === a)
        ((m = p(e.left)), (k = t.left), (P = p(t.right) - g), (y = m + g), (M = e.left + h))
      else if ('x' === i) {
    ...
    drawGrid(t) {
      ...
      if (a) {
        ...
        let r, l, c, d
        ;(e.isHorizontal()
          ? ((r = Ut(o, e.left, a) - a / 2), (l = Ut(o, e.right, n) + n / 2), (c = d = s))
          : ((c = Ut(o, e.top, a) - a / 2), (d = Ut(o, e.bottom, n) + n / 2), (r = l = s)),
    ...
    drawTitle() {
      ...
      'bottom' === e
        ? ((l += a.bottom), Y(i.text) && (l += s.lineHeight * (i.text.length - 1)))
        : (l += a.top)
      const {
        titleX: c,
        titleY: h,
        ...
        return (
          t.isHorizontal()
            ...
            : ((h = zi(t, i, e)), (d = o(n, r, s)), (u = 'left' === i ? -Mt : Mt)),
          ...
          l &&
            ...
            (Ot(e[h], 0, on)
              ...
              : ((o = i[h] / e[h]),
                ...
                r <= 9 ||
                  ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h])))))
    })(t, i, n),
      (function (t, e) {
        const i = t.length
        let n,
        ...
        for (let r = 0; r < i; ++r) {
          ...
          ;(o && ((n = (i - o.x) / 3), (s.cp1x = i - n), (s.cp1y = l - n * e[r])),
            a && ((n = (a.x - i) / 3), (s.cp2x = i + n), (s.cp2y = l + n * e[r])))
        }
      })(t, n))
  }
  function ln(t, e, i) {
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          ((a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = ln(o.cp1x, e.left, e.right)), (o.cp1y = ln(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = ln(o.cp2x, e.left, e.right)), (o.cp2y = ln(o.cp2y, e.top, e.bottom)))))
      })(t, i)
  }
  function hn(t, e, i, n) {
  ...
  function mn(t) {
    return 'angle' === t
      ...
      : { between: (t, e, i) => t >= e && t <= i, compare: (t, e) => t - e, normalize: (t) => t }
  }
  function xn(t, e, i, n) {
  ...
  var vn = Object.freeze({
    ...
    _deprecated: function (t, e, i, n) {
      void 0 !== e &&
        console.warn(t + ': "' + i + '" is deprecated. Please use "' + n + '" instead')
    },
    resolveObjectKey: lt,
    _capitalize: ct,
    defined: ht,
  ...
  class kn {
    ...
    notify(t, e, i) {
      const n = this
      'beforeInit' === e &&
        ((n._init = n._createDescriptors(t, !0)), n._notify(n._init, t, 'install'))
  ...
  function Nn(t) {
    return (
      Hn() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class Yn {
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Hn() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
          ? new Ke()
          : new li()
    }
    clear() {
      ...
      ;(i &&
        ...
        J(s, (i) => {
          ...
          if (a in n && n[a].type === l) c = n[a]
            ...
            ;((c = new (wn.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })), (n[c.id] = c))
          }
          c.init(s, e)
        }),
        J(o, (t, e) => {
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          (s.type && s.type !== a && (t._destroyDatasetMeta(n), (s = t.getDatasetMeta(n))),
          (s.type = a),
    ...
    _updateDataset(t, e) {
      ...
      !1 !== i.notifyPlugins('beforeDatasetUpdate', o) &&
        (n.controller._update(e), (o.cancelable = !1), i.notifyPlugins('afterDatasetUpdate', o))
    }
    render() {
      const t = this
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Bn({ chart: t })))
    }
    draw() {
      const t = this
      let e
      ...
      Y(t)
        ? (function (t, e, i, n) {
            ...
            ;(Math.abs(a) > Math.abs(r) && ((l = r), (c = a)),
              (e[i.axis] = c),
              (e._custom = { barStart: l, barEnd: c, start: o, end: s, min: a, max: r }))
          })(t, e, i, n)
  ...
  function Jn(t, e, i, n) {
    ...
    let c, h, d, u
    for (c = i, h = i + n; c < h; ++c)
      ((u = e[c]), (d = {}), (d[o.axis] = r || o.parse(a[c], c)), l.push(Qn(u, d, s, c)))
    return l
  }
  function to(t) {
  ...
  class eo extends Ai {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g
      for (d = i, u = i + n; d < u; ++d)
        ((g = e[d]), (f = {}), (f[o.axis] = o.parse(lt(g, l), d)), h.push(Qn(lt(g, c), f, s, d)))
      return h
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    _getStacks(t, e) {
      ...
      for (r = 0; r < s; ++r) {
        ...
        if (
          ((!1 === o || -1 === a.indexOf(l.stack) || (void 0 === o && void 0 === l.stack)) &&
            a.push(l.stack),
          l.index === t)
        )
          break
    ...
    _calculateBarIndexPixels(t, e) {
      ...
      if (e.grouped) {
          ...
          l =
            'flex' === o.barThickness
              ...
              : (function (t, e, i, n) {
                  ...
                  return (
                    $(o)
                      ? ((s = e.min * i.categoryPercentage), (a = i.barPercentage))
                      : ((s = o * n), (a = 1)),
        ...
        ((a = n.getPixelForValue(i.getParsed(t)[n.axis], t)), (r = Math.min(s, e.min * e.ratio)))
  ...
  class io extends Ai {
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (c = i, h = i + n; c < h; ++c)
        ((d = e[c]),
          l.push({ x: o.parse(lt(d, a), c), y: s.parse(lt(d, r), c), _custom: d && d.r && +d.r }))
      return l
    }
    getMaxOverflow() {
    ...
    updateElements(t, e, i, n) {
      ...
      for (let l = e; l < e + i; l++) {
        ...
        ;(h && ((u.options = o.resolveDataElementOptions(l, n)), s && (u.options.radius = 0)),
    ...
    update(t) {
      ...
      let { start: r, count: l } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          ;(d &&
            (o = Ht(
              Math.min(ie(r, a.axis, c).lo, i ? n : ie(e, l, a.getPixelForValue(c)).lo),
              0,
              n - 1
            )),
            (s = u
              ? Ht(
                  Math.max(ie(r, a.axis, h).hi + 1, i ? 0 : ie(e, l, a.getPixelForValue(h)).hi + 1),
                  o,
                  n
                ) - o
              : n - o))
  ...
  ;((oo.id = 'line'),
    ...
    (oo.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }))
  class so extends Ai {
    constructor(t, e) {
    ...
    _updateRadius() {
      const t = this,
        ...
        s = Math.max(o / 2, 0),
        a =
          (s - Math.max(n.cutoutPercentage ? (s / 100) * n.cutoutPercentage : 1, 0)) /
  ...
  ;((ro.id = 'radar'),
    ...
    (ro.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }))
  class lo extends oo {}
  ;((lo.id = 'scatter'),
  ...
  function ho(t, e) {
    ...
    ;(t.beginPath(),
      t.arc(s, a, r, i - c, n + c),
      l > o ? ((c = o / l), t.arc(s, a, l, n + c, i - c, !0)) : t.arc(s, a, o, n + Mt, i - Mt),
      t.closePath(),
      t.clip())
  }
  function uo(t, e) {
        ...
        (function (t, e, i) {
          ...
          for (
            i &&
              ...
              ho(t, e),
              (e.endAngle = a),
              e.endAngle === e.startAngle && ((e.endAngle += bt), e.fullCircles--)),
              t.beginPath(),
  ...
  function xo(t, e, i, n) {
    ...
    for (d = 0; d <= c; ++d)
      ((u = o[(r + (p ? c - d : d)) % a]),
        u.skip || (g ? (t.moveTo(u.x, u.y), (g = !1)) : h(t, f, u, p, s.stepped), (f = u)))
  ...
  ;((vo.id = 'line'),
    ...
    (vo.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
    (vo.descriptors = { _scriptable: !0, _indexable: (t) => 'borderDash' !== t && 'fill' !== t }))
  class wo extends Oi {
    constructor(t) {
      ;(super(),
        (this.options = void 0),
  ...
  function ko(t, e) {
    ...
    return (
      t.horizontal
        ? ((d = a / 2), (r = Math.min(i, o)), (l = Math.max(i, o)), (c = n - d), (h = n + d))
        : ((d = s / 2), (r = i - d), (l = i + d), (c = Math.min(n, o)), (h = Math.max(n, o))),
  ...
  function Po(t, e, i, n) {
    ...
    return (
      n
        ? ((a = i), (t = Do((t = (o = t) === (s = e) ? a : o === a ? s : o), i, e)))
        : (t = Do(t, e, i)),
      t
    )
  }
  ...
  ;((wo.id = 'point'),
    ...
    (wo.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }))
  class Ro extends Oi {
    constructor(t) {
      ;(super(),
        (this.options = void 0),
  ...
  ;((Ro.id = 'bar'),
    (Ro.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, pointStyle: void 0 }),
    (Ro.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }))
            ...
            h = (function (t, e, i) {
              ...
              for (o[d++] = t[u], a = 0; a < n - 2; a++) {
                ...
                const m = Math.floor(a * s) + 1,
                  ...
                  { x: b, y: _ } = t[u]
                for (l = c = -1, e = m; e < x; e++)
                  ((c = 0.5 * Math.abs((b - i) * (t[e].y - _) - (b - t[e].x) * (n - _))),
                    c > l && ((l = c), (r = t[e]), (h = e)))
                ;((o[d++] = r), (u = h))
              }
  ...
  function Bo(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          let l, c, h
          if (
            ((h = 'start' === i ? a : 'end' === i ? r : U(i) ? i.value : e.getBaseValue()),
            n.grid.circular)
          )
            return (
              (c = e.getPointPositionForValue(0, a)),
              new Vo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            )
      ...
      : (function (t) {
          ...
          return (
            ...
            X(o) ? ((n = e.isHorizontal()), { x: n ? o : null, y: n ? null : o }) : null
          )
        })(t)
  }
  function Wo(t) {
            ...
            return (
              e.segments.forEach((t) => {
                ...
                null !== n
                  ...
                  : null !== i && (s.push({ x: i, y: e.y }), s.push({ x: i, y: a.y }))
              }),
              s
            )
          })(t, e)),
      i.length ? new vo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n }) : null
    )
  }
  function Yo(t, e, i) {
    let n = t[e].fill
  ...
  class ts extends Oi {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const l of i)
          (a !== l.row && ((a = l.row), (r = o(n, t.left + s, t.right - t.lineWidths[a]))),
            (l.top += t.top + e + s),
            (l.left = r),
            (r += l.width + s))
      } else {
        ...
        for (const l of i)
          (l.col !== a &&
            ((a = l.col), (r = o(n, t.top + e + s, t.bottom - t.columnSizes[a].height))),
            (l.top = r),
            (l.left += t.left + s),
            (r += l.height + s))
      }
    ...
    _draw() {
      ...
      ;((m = y
        ...
        : { x: t.left + f, y: o(r, t.top + v + f, t.bottom - i[0].height), line: 0 }),
      ...
      ;(t.legendItems.forEach((e, u) => {
        ...
        ;(h.setWidth(t.width),
          y
            ? u > 0 &&
              P + S + f > t.right &&
              ((D = m.y += M), m.line++, (P = m.x = o(r, t.left + f, t.right - n[m.line])))
            : u > 0 &&
              D + M > t.bottom &&
    ...
    drawTitle() {
      ...
      let u,
        ...
        g = t.width
      if (this.isHorizontal())
        ((g = Math.max(...t.lineWidths)), (u = t.top + d), (f = o(e.align, f, t.right - g)))
      else {
  ...
  class ps extends Oi {
    ...
    getContext() {
      ...
      return (
        ...
        (t.$context =
          ...
          (i = t),
          (n = t._tooltipItems),
          Object.assign(Object.create(e), { tooltip: i, tooltipItems: n, type: 'tooltip' })))
      )
      var e, i, n
    }
    getTitle(t, e) {
    ...
    update(t, e) {
      ...
      ;((i._tooltipItems = a),
        ...
        t && n.external && n.external.call(i, { chart: i._chart, tooltip: i, replay: e }))
    }
    drawCaret(t, e, i, n) {
      ...
      return (
        'center' === o
          ? ((p = l + h / 2),
            ...
            (f = d))
          : ((u = 'left' === n ? r + s + a : 'right' === n ? r + c - s - a : this.caretX),
            'top' === o
      ...
      for (
        ...
        for (
          m = o[_],
            ...
            J(m.before, g),
            b = m.lines,
            r && b.length && (n._drawColorBox(e, t, _, f, i), (d = Math.max(h.lineHeight, l))),
            y = 0,
            M = b.length;
          y < M;
          ++y
    ...
    handleEvent(t, e) {
      ...
      let s = !1,
        a = []
      'mouseout' !== t.type &&
        ((a = i._chart.getElementsAtEventForMode(t, n.mode, n, e)), n.reverse && a.reverse())
      const r = i._positionChanged(a, t)
      return (
        (s = e || !tt(a, o) || r),
        s &&
          ((i._active = a),
          (n.enabled || n.external) && ((i._eventPosition = { x: t.x, y: t.y }), i.update(!0, e))),
        s
      )
    }
      ...
      defaults: {
        ...
        callbacks: {
          ...
          labelColor(t) {
            ...
            return { borderColor: e.borderColor, backgroundColor: e.backgroundColor }
          },
          labelTextColor() {
  ...
  class _s extends ji {
    ...
    parse(t, e) {
      ...
      return ((t, e) => (null === t ? null : Ht(Math.round(t), 0, e)))(
        (e = isFinite(e) && i[e] === t ? e : bs(i, t, K(e, t))),
        i.length - 1
      )
    }
    determineDataLimits() {
      ...
      ;('ticks' === t.options.bounds && (e || (n = 0), i || (o = t.getLabels().length - 1)),
        (t.min = n),
        (t.max = o))
    }
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        ;((_ = Math.ceil(u / y) - Math.floor(d / y)),
          ...
          f && g && n && Tt((s - o) / n, y / 1e3)
            ? ((_ = Math.min((s - o) / y, l)), (y = (s - o) / _), (x = o), (b = s))
            : p
  ...
  class ws extends ji {
    ...
    getPixelForValue(t) {
      ...
      return (
        ...
        null === t || isNaN(t)
          ? NaN
          : e.getPixelForDecimal(t === e.min ? 0 : (St(t) - e._startValue) / e._valueRange)
      )
    }
    getValueForPixel(t) {
      const e = this,
  ...
  ;((ws.id = 'logarithmic'),
    (ws.defaults = { ticks: { callback: Ei.formatters.logarithmic, major: { enabled: !0 } } }))
  class Os extends ys {
    constructor(t) {
      ;(super(t),
        (this.xCenter = void 0),
  ...
  function Es(t, e) {
    ...
    return (
      ...
      null === r
        ...
        : (s &&
            (r =
              'week' !== s || (!At(a) && !0 !== a) ? i.startOf(r, s) : i.startOf(r, 'isoWeek', a)),
          +r)
    )
  }
  function Is(t, e, i, n) {
