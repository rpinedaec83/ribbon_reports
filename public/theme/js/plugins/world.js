!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(e)
      : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).jsVectorMap = e())
})(this, function () {
  'use strict'
  ;(Element.prototype.matches ||
    (Element.prototype.matches =
      ...
      function (t) {
        for (
          var e = (this.document || this.ownerDocument).querySelectorAll(t), i = e.length;
          --i >= 0 && e.item(i) !== this;
  ...
  function p(t, e, i) {
    ...
    return (
      ...
      c(e).forEach(function (a) {
        ;(function (t, e) {
          return (
            u(t, e) && !(Object.hasOwnProperty.call(t, e) && Object.propertyIsEnumerable.call(t, e))
          )
        })(t, a) ||
      ...
      return (
        ...
        (e.prototype.applyAttr = function (e, i) {
          ...
          'image' === e
            ...
            : 'cx' == e
              ? ((this.cx = i),
                this.width && this.applyAttr('x', i - this.width / 2 + this.offset[0]))
              : 'cy' == e
                ? ((this.cy = i),
                  this.height && this.applyAttr('y', i - this.height / 2 + this.offset[1]))
  ...
  function k(t, e, i) {
    ...
    return (
      i && (n = a + '.tooltip:show'),
      {
        ...
        tooltipText:
          'region' === a ? t.mapData.paths[r].name || '' : t.markers[r].config.name || '',
      }
    )
  }
  var x = (function () {
      ...
      return (
        ...
        (e.clear = function () {
          ...
          for (t in this._values)
            this._elements[t] &&
              (e[t] = this._elements[t].element.shape.style.initial[this.config.attribute])
    ...
    lcc: function (t, e, i) {
      var s = i * this.radDeg,
        ...
        h =
          ...
          Math.log(Math.tan(Math.PI / 4 + n / 2) * (1 / Math.tan(Math.PI / 4 + r / 2))),
    ...
    return (
      (e.setMinMaxValues = function (t) {
        for (var e in ((this.min = Number.MAX_VALUE), (this.max = 0), t))
          ((e = parseFloat(t[e])) > this.max && (this.max = e), e < this.min && (this.min = e))
      }),
      (e.visualize = function () {
        var t,
          e = {}
        for (var i in this._values)
          ((t = parseFloat(this._values[i])), isNaN(t) || (e[i] = this.getValue(t)))
        this.setAttributes(e)
      }),
      (e.setAttributes = function (t) {
      ...
      (e.getValue = function (t) {
        for (var e, i = '#', s = 0; s < 3; s++)
          i +=
            ...
            (e = Math.round(
              this._fromColor[s] +
                (this._toColor[s] - this._fromColor[s]) * ((t - this.min) / (this.max - this.min))
            ).toString(16)).length
              ? '0'
              : '') + e
        return i
      ...
      (e.hexToRgb = function (t) {
        ...
        return (
          4 == t.length
            ? ((e = '0x' + t[1] + t[1]), (i = '0x' + t[2] + t[2]), (s = '0x' + t[3] + t[3]))
            : 7 == t.length &&
              ((e = '0x' + t[1] + t[2]), (i = '0x' + t[3] + t[4]), (s = '0x' + t[5] + t[6])),
  ...
  var T = Object.freeze({
        ...
        ;(this.container.delegate('.jvm-element', 'mouseover mouseout', function (e) {
          ...
          this.container.delegate('.jvm-element', 'mouseup', function (e) {
            ...
            if (
              ...
              ('marker' === i.type && t.params.markersSelectable && !e.defaultPrevented)
            ) {
              var s = i.element
              ;(t.params[i.type + 'sSelectableOne'] && t.clearSelected(i.type + 's'),
                i.element.isSelected ? s.select(!1) : s.select(!0),
                t.emit(i.event, [i.code, s.isSelected, t.getSelected(i.type + 's')]))
            }
          }))
      },
      ...
      createRegions: function () {
        ...
        for (t in ((this.regionLabelsGroup =
          this.regionLabelsGroup || this.canvas.createGroup('jvm-regions-labels-group')),
        this.mapData.paths))
          ((e = new M({
            map: this,
            code: t,
      ...
      createMarkers: function (t, e) {
        ...
        (this.markerLabelsGroup =
          this.markerLabelsGroup || this.canvas.createGroup('jvm-markers-labels-group')),
        t)) {
          ...
          this.container.on('mousemove', function (i) {
            if ('block' === t.tooltip.selector.style.display) {
              var s = t.container.selector
                ...
                l = i.pageX - n - 5
              ;(o && ((h += r + 5), (l -= 10)),
                i.clientX < s.left + n + 5 && ((l = i.pageX + 5 + 2), o && (l += 10)),
                t.tooltip.css({
                  top: h + 'px',
                  left: l + 'px',
                }))
      ...
      applyTransform: function () {
        ...
        ;(this.defaultWidth * this.scale <= this.width
          ...
          : ((t = 0), (i = (this.width - this.defaultWidth * this.scale) / this.scale)),
          this.defaultHeight * this.scale <= this.height
            ? ((e = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)),
              (s = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)))
            : ((e = 0), (s = (this.height - this.defaultHeight * this.scale) / this.scale)),
      ...
      setFocus: function (t) {
        ...
        var i,
          s = []
        if ((t.region ? s.push(t.region) : t.regions && (s = t.regions), s.length))
          return (
      ...
      setScale: function (t, e, i, s, a) {
        ...
        ;(t > this.params.zoomMax * this.baseScale
          ...
          void 0 !== e &&
            ...
            ((r = t / this.scale),
            s
              ? ((d = e + (this.defaultWidth * (this.width / (this.defaultWidth * t))) / 2),
                (f = i + (this.defaultHeight * (this.height / (this.defaultHeight * t))) / 2))
              : ((d = this.transX - ((r - 1) / t) * e), (f = this.transY - ((r - 1) / t) * i))),
          a && v > 0
            ? ((o = this.scale),
              (h = (t - o) / v),
              ...
              (n = setInterval(function () {
                ;((g += 1),
                  ...
                  m.applyTransform(),
                  g == v &&
                    (clearInterval(n), m.emit('viewport:changed', [m.scale, m.transX, m.transY])))
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
      ...
      function t(e) {
        ...
        ;((this.mapData = t.maps[this.params.map]),
          ...
          'loading' !== window.document.readyState
            ...
            : window.addEventListener('DOMContentLoaded', this.init.bind(this, e.selector)))
      }
      var e = t.prototype
      return (
        (e.init = function (t) {
        ...
        (e.reset = function () {
          ...
          ;(this.legendHorizontal &&
            (f.removeElement(this.legendHorizontal), (this.legendHorizontal = null)),
            this.legendVertical &&
              (f.removeElement(this.legendVertical), (this.legendVertical = null)),
