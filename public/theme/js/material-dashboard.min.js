...
;(!(function () {
  ...
  ;-1 < navigator.platform.indexOf('Win') &&
    ...
    document.getElementsByClassName('navbar-collapse')[0] &&
      ((t = document.querySelector('.navbar:not(.navbar-expand-lg) .navbar-collapse')),
...
function sidebarType(e) {
  ...
  ;(('bg-transparent' != s && 'bg-white' != s) || !a
    ? (o = (r = document.querySelector('.navbar-brand-img')).src).includes('logo-ct-dark.png') &&
      ((c = o.replace('logo-ct-dark', 'logo-ct')), (r.src = c))
    : (o = (r = document.querySelector('.navbar-brand-img')).src).includes('logo-ct.png') &&
...
;(0 != document.querySelectorAll('.input-group').length &&
  (allInputs = document.querySelectorAll('input.form-control')).forEach((e) =>
    setAttributes(e, { onfocus: 'focused(this)', onfocusout: 'defocused(this)' })
  ),
          ...
          i.querySelector('li:nth-child(' + n + ') .nav-link').onclick = function () {
            ...
            if (i.classList.contains('flex-column')) {
              ...
              ;((l.style.transform = 'translate3d(0px,' + e + 'px, 0px)'),
                (l.style.height = i.querySelector('li:nth-child(' + t + ')').offsetHeight))
            } else {
              for (t = 1; t <= s.indexOf(a); t++)
                e += i.querySelector('li:nth-child(' + t + ')').offsetWidth
              ;((l.style.transform = 'translate3d(' + e + 'px, 0px, 0px)'),
                (l.style.width = i.querySelector('li:nth-child(' + n + ')').offsetWidth + 'px'))
            }
          }
        }
      }))
      ...
      if (i) {
        ...
        if (s.classList.contains('flex-column')) {
          ...
          ;((n.style.transform = 'translate3d(0px,' + t + 'px, 0px)'),
            (n.style.width = s.querySelector('li:nth-child(' + a + ')').offsetWidth + 'px'),
            (n.style.height = s.querySelector('li:nth-child(' + l + ')').offsetHeight))
        } else {
      ...
      window.innerWidth < 991
        ? total.forEach(function (n, e) {
            if (!n.classList.contains('flex-column')) {
              ...
              ;((i.style.width = n.querySelector('li:nth-child(1)').offsetWidth + 'px'),
        ...
        : total.forEach(function (n, e) {
            if (n.classList.contains('on-resize')) {
              ...
              ;((l.style.transform = 'translate3d(' + s + 'px, 0px, 0px)'),
                (l.style.width = n.querySelector('li:nth-child(' + a + ')').offsetWidth + 'px'))
            }
          }))
  }),
  window.innerWidth < 991 &&
  ...
  if (e.getAttribute('checked')) {
    ...
    for (y = 0; y < a.length; y++)
      a[y].classList.contains('text-white') &&
        (a[y].classList.remove('text-white'), a[y].classList.add('text-dark'))
    for (y = 0; y < l.length; y++)
      !l[y].classList.contains('text-white') ||
        l[y].closest('.sidenav') ||
        l[y].closest('.card.bg-gradient-dark') ||
        (l[y].classList.remove('text-white'), l[y].classList.add('text-dark'))
    for (y = 0; y < o.length; y++)
      o[y].classList.contains('text-white') &&
        (o[y].classList.remove('text-white'), o[y].classList.add('text-dark'))
    for (y = 0; y < d.length; y++)
      d[y].classList.contains('text-white') &&
        !d[y].closest('.sidenav') &&
        (d[y].classList.remove('text-white'), d[y].classList.add('text-dark'))
    ...
    for (y = 0; y < g.length; y++)
      g[y].classList.contains('bg-gray-600') &&
        (g[y].classList.remove('bg-gray-600'), g[y].classList.add('bg-gray-100'))
    for (y = 0; y < L.length; y++) L[y].hasAttribute('fill') && L[y].setAttribute('fill', '#252f40')
    for (y = 0; y < m.length; y++)
      m[y].closest('.card.bg-gradient-dark') ||
        (m[y].classList.remove('text-white'), m[y].classList.add('text-dark'))
    ...
    for (var y = 0; y < a.length; y++)
      a[y].classList.contains('text-dark') &&
        (a[y].classList.remove('text-dark'), a[y].classList.add('text-white'))
    for (var y = 0; y < i.length; y++)
      i[y].classList.contains('text-dark') &&
        (i[y].classList.remove('text-dark'), i[y].classList.add('text-white'))
    for (var y = 0; y < r.length; y++)
      r[y].classList.contains('text-dark') &&
        (r[y].classList.remove('text-dark'), r[y].classList.add('text-white'))
    for (var y = 0; y < c.length; y++)
      c[y].classList.contains('text-dark') &&
        (c[y].classList.remove('text-dark'), c[y].classList.add('text-white'))
    ...
    for (var y = 0; y < f.length; y++)
      f[y].classList.contains('bg-gray-100') &&
        (f[y].classList.remove('bg-gray-100'), f[y].classList.add('bg-gray-600'))
