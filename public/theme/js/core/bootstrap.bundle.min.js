...
!(function (t, e) {
  ...
  class st extends B {
    ...
    _getConfig(t) {
      return (
        (t = { ...X, ...U.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }),
        a(K, t, Y),
        t
      )
    }
  ...
  function qt(t) {
    return (
      'undefined' != typeof ShadowRoot && (t instanceof Wt(t).ShadowRoot || t instanceof ShadowRoot)
    )
  }
  const Ft = {
    name: 'applyStyles',
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === Ke ||
            (t.key !== Ve && ((t.key !== Ye && t.key !== Xe) || t.target.closest(ei)))
          : !Qe.test(t.key)
      )
        return
  ...
  class bi {
    ...
    dispose() {
      this._isAppended &&
        (j.off(this._element, _i), this._element.remove(), (this._isAppended = !1))
    }
    _emulateAnimation(t) {
  ...
  class un extends B {
    ...
    _setListeners() {
      ;(this._config.trigger.split(' ').forEach((t) => {
        if ('click' === t)
          j.on(this._element, this.constructor.Event.CLICK, this._config.selector, (t) =>
            this.toggle(t)
          )
        else if ('manual' !== t) {
    ...
    _leave(t, e) {
      ;((e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger['focusout' === t.type ? dn : hn] = e._element.contains(
            t.relatedTarget
          )),
  ...
  class xn extends B {
    ...
    _activate(t, e, i) {
      const n = (
          !e || ('UL' !== e.nodeName && 'OL' !== e.nodeName) ? V.children(e, kn) : V.find(Ln, e)
        )[0],
